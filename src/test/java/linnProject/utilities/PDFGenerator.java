...
public class PDFGenerator {
    ...
    public static void pdfGeneratorRowsAndCellsWithList(String header, List <Customer_Ders_linn> list, String fileName){
    ...
    public static void main(String[] args) {
        ...
        Country_Ders_linn country = new Country_Ders_linn();
        country.setName("USA");
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirst5(String header, List <Customer_Ders_linn> list, String fileName){
